...
const OurMission: FC<OurMissionProps> = ({ slice }) => {
  const { eyebrow_text, section_title, section_subtitle, description } = slice.primary;
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-4 md:px-6 lg:px-10">
        <div className="relative overflow-hidden rounded-3xl border border-violet-100 bg-gradient-to-br from-violet-50 via-white to-indigo-50 p-6 shadow-sm md:p-10 lg:p-12">
